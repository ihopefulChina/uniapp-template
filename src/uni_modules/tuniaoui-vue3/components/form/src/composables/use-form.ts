...
import type { FormContext, FormItemContext, FormValidationCallback, FormValidationResult } from '../types';
...
export const useForm = (props: FormProps) => {
    ...
    // 校验
    const validate = async (callback?: FormValidationCallback): FormValidationResult => validateField(undefined, callback);
