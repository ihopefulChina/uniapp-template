...
const { rectId, bulgeRectInfo, hasBulgeButton, setActiveItemByValue } = useTabbar(props);
const { ns, tabbarClass, tabbarStyle, bgClass, bgStyle, placeholderStyle, bulgeClass, bulgeStyle } = useTabbarCustomStyle(props);
...
<template>
  ...
  <!-- 占位容器 -->
  <view v-if="fixed && placeholder" :class="[ns.e('placeholder'), { 'tn-u-safe-area': safeAreaInsetBottom }]" :style="placeholderStyle" />
</template>

<style lang="scss" scoped>
@use '../../../theme-chalk/src/tabbar.scss' as *;
</style>
