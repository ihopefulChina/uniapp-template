...
import { buildProps, definePropType, isArray, isNumber, isString } from '../../../utils';
...
export const calendarProps = buildProps({
    ...
    rangeStartDesc: {
        type: String,
        default: i18n.global.t('common.start_date'),
    },
    /**
    ...
    rangeEndDesc: {
        type: String,
        default: i18n.global.t('common.end_date'),
    },
});

export const calendarEmits = {
    [UPDATE_MODEL_EVENT]: (value: CalendarModelValueType) => isArray(value) || isString(value),
    [CHANGE_EVENT]: (value: CalendarModelValueType) => isArray(value) || isString(value),
    /**
     * @description 年份切换事件
     */
