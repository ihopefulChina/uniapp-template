...
export const popupOpenDirection = ['top', 'bottom', 'left', 'right', 'center'] as const;

export const popupCloseBtnPosition = ['left-top', 'right-top', 'left-bottom', 'right-bottom'] as const;
