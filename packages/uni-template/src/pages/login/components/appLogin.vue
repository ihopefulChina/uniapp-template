...
<template>
  <view class="loginPage">
    ...
    <view class="allPageBg whiteBg zindex-10" />

    <veiw class="login-container">
      <view class="input-container">
        <view class="input-phone-type">
          +86
        </view>
        <input v-model="mobile" type="number" class="input-phone-text" placeholder="请输入手机号">
      </view>
      ...
      <view class="mt-3 flex flex-start common_agreement" style="justify-content: flex-start"
        ...
        <view class="common_login_agreement" @click.prevent.stop="jumpAgreement">
          《用户协议》
        </view>
      </view>
      <view class="publicButton mt-10">
        <button class="btn default" type="submit" :class="{ isDisabled: isDisabled }" @click="submit">
          保存
        </button>
      </view>
    </veiw>
