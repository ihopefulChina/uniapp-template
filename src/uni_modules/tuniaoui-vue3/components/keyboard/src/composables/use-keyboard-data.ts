...
import { carKeyboardCnData, carKeyboardEnData, carKeyboardSpecialData } from '../../libs';
...
export const useKeyboardData = (props: KeyboardProps, carLang: Ref<CarKeyboardLang>) => {
    // 生成普通键盘数据
    const generateNormalKeyboardData = (digit = false, idcard = false, random = false): KeyboardData => {
