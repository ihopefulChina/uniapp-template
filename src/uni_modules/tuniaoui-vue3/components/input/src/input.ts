import { buildProps, definePropType, isNumber, isObject, isString } from '../../../utils';
import { useComponentCustomStyleProp, useFormSizeProps } from '../../base/composables/use-component-common-props';
...
const inputConfirmTypes = ['send', 'search', 'next', 'go', 'done', 'return'] as const;
...
export const inputEmits = {
    [UPDATE_MODEL_EVENT]: (value: string | number) => isString(value) || isNumber(value),
    /**
     ...
     */
    [CHANGE_EVENT]: (value: string | number) => isString(value) || isNumber(value),
    /**
