 ...
 * @return Cn string
 */
const nStr3: string[] = ['\u6B63', '\u4E8C', '\u4E09', '\u56DB', '\u4E94', '\u516D', '\u4E03', '\u516B', '\u4E5D', '\u5341', '\u51AC', '\u814A'];
 ...
 */
export const solar2lunar = (yPara: string | number, mPara: string | number, dPara: string | number): SolarData | -1 => {
 ...
 */
export const lunar2solar = (y: string | number, m: string | number, d: string | number, isLeapMonth: boolean): SolarData | -1 => {
