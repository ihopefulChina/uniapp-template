...
import { buildProps, definePropType, isArray, isBoolean, isNumber, isString } from '../../../utils';
...
export const pickerEmits = {
    [UPDATE_MODEL_EVENT]: (value: PickerValueType) => isString(value) || isNumber(value) || isArray(value),
