...
const { pickerSelectData, showPicker, currentSelectValue, handlePickerCloseEvent, handlePickerChangeEvent, handlePickerConfirmEvent, handlePickerCancelEvent } = useRegionPicker(props, emits);
</script>
