...
import type { CheckboxGroupEmits, CheckboxGroupProps, CheckboxGroupValueType } from '../checkbox-group';

export const useCheckboxGroup = (props: CheckboxGroupProps, emits: SetupContext<CheckboxGroupEmits>['emit']) => {
