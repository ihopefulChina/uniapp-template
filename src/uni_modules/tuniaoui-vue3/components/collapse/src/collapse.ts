...
export const collapseEmits = {
    [UPDATE_MODEL_EVENT]: (value: CollapseModelValue) => isArray(value) || isString(value) || isNumber(value),
    [CHANGE_EVENT]: (value: CollapseModelValue) => isArray(value) || isString(value) || isNumber(value),
};
