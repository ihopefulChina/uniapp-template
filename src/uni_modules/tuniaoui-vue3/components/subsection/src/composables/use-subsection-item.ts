...
import type { SubsectionItemEmits, SubsectionItemProps } from '../subsection-item';
import type { SubsectionItemRect } from '../types';

export const useSubsectionItem = (props: SubsectionItemProps, emits: SetupContext<SubsectionItemEmits>['emit']) => {
