...
export const useEmptyCustomStyle = (props: EmptyProps, customIconContent: Ref<boolean>, customTipsContent: Ref<boolean>) => {
    const ns = useNamespace('empty');

    // 解析颜色
    const [textColorClass, textColorStyle] = useComponentColor(toRef(props, 'color'), 'text');
