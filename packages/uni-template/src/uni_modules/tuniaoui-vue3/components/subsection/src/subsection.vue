...
const { ns, subsectionClass, subsectionStyle, subsectionSliderClass, subsectionSliderStyle } = useSubsectionCustomStyle(props, activeColor, sliderRectInfo);
</script>
...
@use '../../../theme-chalk/src/subsection.scss' as *;
</style>
