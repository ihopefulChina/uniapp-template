import { useComponentCustomStyleProp, useComponentIndexProp } from '../../base/composables/use-component-common-props';
...
export const badgeEmits = {
     ...
     * @description 点击事件
     */
    click: (index: ComponentIndex) => typeof index === 'number' || typeof index === 'string',
};
