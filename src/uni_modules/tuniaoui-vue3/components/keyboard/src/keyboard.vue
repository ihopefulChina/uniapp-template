        ...
        <view class="tn-u-safe-area" :class="[ns.b(), ns.e(mode)]">
            ...
            <template v-if="mode !== 'car'">
                ...
                <view class="right" :class="ns.e('normal-container')">
                    ...
                    <view class="normal-item confirm" hover-class="keyboard-btn-hover" :hover-stay-time="150" @tap.stop="keyboardClickEvent('confirm', false)"> {{ t('common.confirm') }} </view>
                </view>
            </template>
            ...
            <template v-if="mode === 'car'">
                ...
                <view :class="[ns.e('car-top-operation-bar')]">
                    <view class="operation-btn cancel" @tap.stop="keyboardClickEvent('cancel', false)"> {{ t('common.cancel') }} </view>
                    <view class="operation-btn confirm" @tap.stop="keyboardClickEvent('confirm', false)"> {{ t('common.confirm') }} </view>
                </view>
                <view :class="[ns.e('car-container')]">
                    ...
                    <view v-for="(item, index) in carKeyboardData" :key="index" class="column-data">
                        ...
                        <view v-if="index === 3" class="car-item switch-mode" hover-class="keyboard-btn-hover" :hover-stay-time="150" @tap.stop="carKeyboardSwitchLang">
                            {{ carKeyboardLang === 'cn' ? 'ABC' : t('common.back') }}
                        </view>
