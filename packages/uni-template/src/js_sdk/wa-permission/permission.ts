...
export function judgeIosPermissionRecord() {
  let result = false
  const ios = plus?.ios as any
  const avaudiosession = ios?.import('AVAudioSession')
...
export function judgeIosPermissionCamera() {
  let result = false
  const ios = plus?.ios as any
  const AVCaptureDevice = ios?.import('AVCaptureDevice')
...
export function judgeIosPermissionPhotoLibrary() {
  let result = false
  const ios = plus?.ios as any
  const PHPhotoLibrary = ios?.import('PHPhotoLibrary')
...
export function judgeIosPermissionContact() {
  let result = false
  const ios = plus?.ios as any
  const CNContactStore = ios?.import('CNContactStore')
...
export function judgeIosPermissionCalendar() {
  let result = false
  const ios = plus?.ios as any
  const EKEventStore = ios?.import('EKEventStore')
