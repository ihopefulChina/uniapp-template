...
export const useAvatarGroup = (props: AvatarGroupProps, emits: SetupContext<AvatarGroupEmits>['emit']) => {
    const { children: avatarItems, addChild: addItem, removeChild: removeItem } = useOrderedChildren<AvatarContext>();
