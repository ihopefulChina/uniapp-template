...
export const useCollapseItemCustomStyle = () => {
    ...
    // 解析颜色
    const [arrowColorClass, arrowColorStyle] = useComponentColor(toRef(collapse!, 'arrowColor'), 'text');
    ...
    const arrowStyle = computed<CSSProperties>(() => {
        ...
        if (!arrowColorClass.value) style.color = arrowColorStyle.value || 'var(--tn-color-gray)';
