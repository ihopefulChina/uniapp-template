...
export const useSliderNodeInfo = (props: SliderProps) => {
    ...
    const { mode, sliderValue, precision, updateSliderValue, changeSliderValue } = useSlider(props);
    ...
    const { currentX: sliderBarCurrentX, updateOptions: sliderTouchUpdateOptions, onTouchStart: sliderTouchStart, onTouchMove: sliderTouchMove, onTouchEnd: sliderTouchEnd } = useTouch();
