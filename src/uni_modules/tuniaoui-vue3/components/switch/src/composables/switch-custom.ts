...
export const useSwitchCustomStyle = (props: SwitchProps, selected: Ref<boolean>) => {
    ...
    const [activeTextColorClass, activeTextColorStyle] = useComponentColor(toRef(props, 'activeColor'), 'text');
    const [inactiveTextColorClass, inactiveTextColorStyle] = useComponentColor(toRef(props, 'inactiveColor'), 'text');
