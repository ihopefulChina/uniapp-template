import { buildProps, definePropType, isBoolean, isNumber, isString } from '../../../utils';
...
export const switchEmits = {
    [UPDATE_MODEL_EVENT]: (value: switchValueType) => isString(value) || isNumber(value) || isBoolean(value),
    [CHANGE_EVENT]: (value: switchValueType) => isString(value) || isNumber(value) || isBoolean(value),
};
