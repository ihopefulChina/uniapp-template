...
export const useTabbarItem = (props: TabbarItemProps, emit: SetupContext<TabbarItemEmits>['emit']) => {
    ...
    // 图标尺寸
    const iconSize = computed<string>(() => props.iconSize || tabbarContext?.iconSize || '');
