...
const { subsectionItemClass, subsectionItemStyle } = useSubsectionItemCustomStyle(props, active);
</script>
...
<template>
  <view :id="componentId" :class="[subsectionItemClass]" :style="subsectionItemStyle" @tap.stop="itemClickEvent">
    <slot>
      {{ title }}
    </slot>
  </view>
...
@use '../../../theme-chalk/src/subsection-item.scss' as *;
</style>
