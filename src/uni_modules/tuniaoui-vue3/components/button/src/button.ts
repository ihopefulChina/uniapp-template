...
import { useComponentCustomStyleProp, useComponentSizeProp } from '../../base/composables/use-component-common-props';
 ...
 * 按钮OpenType有效值
 */
export const buttonOpenTypes = ['feedback', 'share', 'contact', 'getPhoneNumber', 'launchApp', 'openSetting', 'getUserInfo', 'chooseAvatar', 'agreePrivacyAuthorization'] as const;
