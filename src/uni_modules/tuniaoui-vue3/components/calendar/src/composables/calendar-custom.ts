...
export const useCalendarCustomStyle = (props: CalendarProps) => {
    ...
    const [rangeBgColorClass, rangeBgColorStyle] = useComponentColor(toRef(props, 'rangeBgColor'), 'bg');
    const [rangeTextColorClass, rangeTextColorStyle] = useComponentColor(toRef(props, 'rangeTextColor'), 'text');
