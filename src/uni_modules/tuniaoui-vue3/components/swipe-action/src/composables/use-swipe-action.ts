...
export const useSwipeAction = (props: SwipeActionProps, emits: SetupContext<SwipeActionEmits>['emit']) => {
    const { children: items, addChild: addItem, removeChild: removeItem } = useOrderedChildren<SwipeActionItemContext>();
