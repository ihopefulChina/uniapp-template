...
export const useModalCustomStyle = (cancelBtnStyle: Ref<ModalBtnStyle>, confirmBtnStyle: Ref<ModalBtnStyle>) => {
    ...
    const operationBtnStyle = computed<OperationBtnComputedStyle>(() => {
        return (type: 'cancel' | 'confirm') => {
            ...
            if (type === 'cancel') {
                if (cancelBtnBgStyle.value) style.backgroundColor = cancelBtnBgStyle.value;
            ...
            if (type === 'confirm') {
                if (confirmBtnBgStyle.value) style.backgroundColor = confirmBtnBgStyle.value;
