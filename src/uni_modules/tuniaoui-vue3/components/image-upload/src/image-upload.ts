...
export const imageExtensions = ['jpg', 'jpeg', 'png', 'gif', 'webp', 'ico'] as const;

export type ImageUploadCustomFunction = (file: ImageUploadFile) => Promise<string> | string;

export type ImageUploadCustomCallbackFunction = (data: UniApp.UploadFileSuccessCallbackResult) => Promise<string> | string;

export type ImageBeforeUploadFunction = (file: ImageUploadFile) => boolean | Promise<boolean>;

export type ImageBeforeRemoveFunction = (file: ImageUploadListItem) => boolean | Promise<boolean>;
