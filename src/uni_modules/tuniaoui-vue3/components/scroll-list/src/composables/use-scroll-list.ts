...
export const useScrollList = (props: ScrollListProps, emits: SetupContext<ScrollListEmits>['emit']) => {
    ...
    const getContentRectInfo = async () => {
        try {
            ...
            const contentRectInfo = await getSelectorNodeInfo(`#${componentContentId}`);
