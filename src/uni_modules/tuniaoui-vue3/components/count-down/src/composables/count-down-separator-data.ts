...
type CountDownSeparatorData = Record<CountDownSeparatorMode, CountDownSeparatorItem>;
...
export const useCountDownSeparatorData = () => {
    ...
    const getSeparatorData = (mode: CountDownSeparatorMode, key: keyof CountDownSeparatorItem) => {
